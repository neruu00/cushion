    ...
    <PageShell className="space-y-12 py-14">
      <section className="space-y-5">
        ...
        <p className="max-w-xl text-muted-foreground">
          스펙·ADR·런북·회의록·용어집 — 프로젝트 문서를 한곳에 모아 두면, 에이전트가 MCP로{" "}
          <strong className="text-foreground">필요한 조각만</strong> 읽고 써요. 사람이 아니라
          에이전트를 1차 독자로 삼은 서가예요. 같은 문서를 세션마다 통째로 다시 싣느라 태우는
          토큰을 줄이는 게 목적의 전부예요.
        </p>
        <p className="max-w-xl text-sm text-muted-foreground">
          자기 자신의 문서로 재 보면 전량 로드 대비{" "}
          <strong className="text-foreground">20% 미만 — 5배 이상 절감</strong>이에요.
        </p>
        ...
        <p className="text-xs text-muted-foreground">
          로그인하면 바로 라이브러리를 만들 수 있어요. 문서 열람은 멤버만 가능해요.{" "}
